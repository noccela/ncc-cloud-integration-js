...
export declare function getFilteredCallback(filterClass: typeof BaseFilter, callback: (err: string, payloa: object) => void, filters: Types.MessageFilter, dependencies: Dependencies): FilteredCallback;
export declare class FilteredCallback {
     ...
     */
    constructor(callback: (err: string | null, payloa: object | null) => void, filter: BaseFilter, dependencies: Dependencies);
    process(_: string, payload: object): void;
}
/**
