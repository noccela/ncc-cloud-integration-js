...
import { AUTH_TOKEN_ENDPOINT, DEFAULT_AUTH_ORIGIN, } from "../constants/paths.js";
 ...
 */
export async function getToken(clientId, clientSecret, authOrigin = DEFAULT_AUTH_ORIGIN) {
