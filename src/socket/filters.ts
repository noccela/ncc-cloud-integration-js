...
export function getFilteredCallback(filterClass: typeof BaseFilter, callback: (err: string, payloa: object) => void, filters: Types.MessageFilter, dependencies: Dependencies): FilteredCallback {
